import Logo from '@assets/img/JYM-logo.png';
        ...
        >
          <div className="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
              ...
              <React.Fragment key={index}>
                <div className="menu-item">
                  <div className="menu-content pb-2">
                    <span className="menu-section text-muted text-uppercase fs-8 ls-1">{menuItem.name}</span>
                  </div>
                </div>
                {menuItem.children.map((subMenuItem, subMenuIndex) => (
                  <div key={subMenuIndex} className="menu-item">
                    <Link className="menu-link" to={subMenuItem.link}>
            ...
            <div data-kt-menu-trigger="click" className="menu-item here show menu-accordion">
              ...
              <div className="menu-sub menu-sub-accordion menu-active-bg">
                <div className="menu-item">
                  <a className="menu-link active" href="../../demo1/dist/layouts/aside/light.html">
                    <span className="menu-bullet">
                      <span className="bullet bullet-dot"></span>
                    </span>
